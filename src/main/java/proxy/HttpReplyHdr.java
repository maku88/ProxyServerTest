...
//    static String HTTP_SERVER="Java Experimental Server 0.1";
//
//    String lastModified = "";
//    long   contentLength=0;
//    String extraErrorString ="";
//    boolean withinHeader = true;
//    long lastModificationDate = 10000;
//    String mimeType = "";
//
//
//    public void checkHeaderInfo (String line)
//    {
...
//
//
//    private void checkToken (StringTokenizer st, String src)
//            throws Exception
//    {
//        String token = st.nextToken();
//
//        if (token.equalsIgnoreCase("last-modified"))
//            setModifiedDate(src.substring(15, src.length()));
//        else if (token.equalsIgnoreCase("content-type"))
//            setMimeType(st.nextToken());
//    }
//
//
//    /**
...
//     */
//    private void setModifiedDate (String token)
//    {
//        long lmd = Date.parse(token);
//        if (lmd > 0)
//            lastModificationDate = lmd;
//        else
//            System.out.println("Not Ok: " + token);
//    }
//
//
//    /**
//     * Sets the Content-type for a header;
//     *
//     * @param date  A string holding an interner date
//     */
//    private void setMimeType (String token)
//    {
//        if (token.length() > 1)
//            mimeType = token;
//    }
