...
//
//    /**
//     * Http IRequest method. Such as get or post.
//     */
...
//
//    public String requestContent = new String();
//
//    static String CR ="\r\n";
//
//
...
//            tz = new StringTokenizer(line = lines.readLine());
//            //System.out.println(line);
//            //requestContent += line + CR;
//        } catch (Exception e) {
//            return false;
//        }
//
...
//            method = "GET";
//
//        IRequest = method +" "+ url + " HTTP/1.0" + CR;
//
//        if (0 < userAgent.length())
//            IRequest +="User-Agent:" + userAgent + CR;
//
//        if (0 < referer.length())
//            IRequest+= "Referer:"+ referer  + CR;
//
//        if (pragmaNoCache)
//            IRequest+= "Pragma: no-cache" + CR;
//
//        if (0 < ifModifiedSince.length())
//            IRequest+= "If-Modified-Since: " + ifModifiedSince + CR;
//
//        // ACCEPT TYPES //
//        if (0 < accept.length())
//            IRequest += "Accept: " + accept + CR;
//        else
//            IRequest += "Accept: *" + "/" + "* \r\n";
//
//        if (0 < contentType.length())
//            IRequest += "Content-Type: " + contentType   + CR;
//
//        if (0 < contentLength)
//            IRequest += "Content-Length: " + contentLength + CR;
//
//
//        if (0 != authorization.length())
//            IRequest += "Authorization: " + authorization + CR;
//
//        if (sendUnknowen) {
//            if (0 != unrecognized.length())
//                IRequest += unrecognized;
//        }
//
//        IRequest += CR;
//
